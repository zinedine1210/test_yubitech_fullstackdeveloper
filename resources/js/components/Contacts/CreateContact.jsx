...
export default function CreateContact() {
  ...
  const [data, setData] = useState({
    "nama":"",
    "email":"",
    "dial":{name:"Indonesia", dial_code:"+62"},
    "nomor_telepon":""
  })
  ...
  const savePost = async () => {
    ...
    obj['id'] = context.auth.id

    try {
      const result = await axios.post('/api/contacts', obj, {
        headers: {
      ...
      if(result.data.success){
        context.dataContacts.push(result.data.data)
            ...
            <div className='space-y-3 my-5'>
              ...
              <div>
                ...
                <div className='relative input-style'>
                  ...
                  <input type="text" id="nomor_telepon"  value={data.nomor_telepon} onChange={(e) => setData({...data, nomor_telepon:e.target.value})} className='outline-none pl-14 w-full' name="nomor_telepon" pattern="[0-9]{10,15}" required placeholder='895...'/>
                </div>
                {
                    validation.dial && (
